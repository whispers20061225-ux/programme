...
/* First firmware major version for STLink v3)--------------------------------*/
#define FIRMWARE_MIN_MAJOR_VER_STLINKV3 3

/* First firmware major version for STLink v3PWR------------------------------*/
#define FIRMWARE_MIN_MAJOR_VER_STLINKV4 4
