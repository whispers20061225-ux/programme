# Tactile Grasp Studio 术语与缩写表

- [返回仓库 README](../README.md)
- [返回文档索引](README.md)
- [返回系统总览](system_overview_manual.md)

这份文档只做一件事：把第一次读 Tactile Grasp Studio 时最容易卡住的缩写、术语和口语化说法拆开讲清楚。
...
| GraspGen | 外部抓取候选生成后端 | 当前主链默认主要使用的外部候选生成服务。 |
...
- 如果你想先学会操作 Web：看 [Web 控制台说明书](web_console_manual.md)
- 如果你想搞懂 ROI 是怎么锁住目标的：看 [语义感知说明书](semantic_perception_manual.md)
- 如果你想搞懂点云、反投影和补全：看 [点云与几何说明书](pointcloud_geometry_manual.md)
- 如果你想搞懂 pregrasp / grasp 为什么会失败：看 [抓取规划与执行说明书](grasp_execution_manual.md)
