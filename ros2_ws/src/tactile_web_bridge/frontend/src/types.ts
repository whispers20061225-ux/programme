...
export interface UiState {
  ...
  tactile: {
    ...
    start_addr?: number;
    returned_data_len_hint?: number;
    frame_len_declared?: number;
    payload_len_observed?: number;
    payload_value_count?: number;
    transport_rate_hz?: number;
